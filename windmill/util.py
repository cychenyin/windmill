...
__all__ = ('asint', 'asbool', 'astimezone', 'convert_to_ware_datetime', 'datetime_to_utc_timestamp',
           'utc_timestamp_to_datetime', 'timedelta_seconds', 'datetime_ceil', 'get_callable_name', 'obj_to_ref',
           'ref_to_obj', 'maybe_ref', 'repr_escape', 'check_callable_args' , 'local_timestamp_to_datetime'
#            ,'datetime_now', 'timestamp_now', 'from_timestamp_to_datetime'
            , 'datetime_to_timestamp', 'from_datetime_to_timestamp'
           )
...
# 
# def timestamp_now():
#     return from_datetime_to_timestamp(datetime_now())
...
def convert_to_ware_datetime(input, tz, arg_name):
    """
    ...
    if input is None:
        ...
        datetime_ = datetime.datetime.combine(input, time())
...
def local_timestamp_to_datetime(timestamp,tz='Asia/Shanghai'):
    '''
    refer: https://gist.github.com/jul1an/5488075
    convert timestamp to local datetime using definite timezone
    '''
    import pytz
...
def datetime_ceil(dateval):
    ...
    if dateval.microsecond > 0:
        return dateval + datetime.timedelta(seconds=1, microseconds=-dateval.microsecond)
    return dateval
...
if __name__ == "__main__":
    ...
    print(datetime_to_utc_timestamp(datetime.datetime.now( get_localzone())))
    
#         print 'get_due_jobsssssssssssssssssssssssssssssssssssssssssssssssssss'
#         print datetime_to_utc_timestamp(now)
#         print datetime_to_timestamp(now)
#         print from_datetime_to_timestamp(now)
#         print 'get_due_jobsssssssssssssssssssssssssss1'
#         now = datetime.now()
#         print datetime_to_utc_timestamp(now)
#         print datetime_to_timestamp(now)
#         print from_datetime_to_timestamp(now)
#         print 'get_due_jobsssssssssssssssssssssssssss2'
#         from tzlocal import get_localzone
