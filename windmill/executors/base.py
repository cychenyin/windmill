...
from windmill.events import JobExecutionEvent, EVENT_JOB_MISSED, EVENT_JOB_ERROR, EVENT_JOB_EXECUTED
...
class BaseExecutor(six.with_metaclass(ABCMeta, object)):
    ...
    _scheduler = None
    _lock = None
#     _logger = logging.getLogger('windmill.executors')
    ...
    def start(self, scheduler, alias):
        ...
        :param windmill.schedulers.base.BaseScheduler scheduler: the scheduler that is starting this executor
