...
setup(
    ...
    entry_points={
        ...
        'apscheduler.dispatchers': [
            'debug = apscheduler.dispatchers.debug:DebugExecutor',
            'threadpool = apscheduler.dispatchers.pool:ThreadPoolExecutor',
            'processpool = apscheduler.dispatchers.pool:ProcessPoolExecutor',
            'asyncio = apscheduler.dispatchers.asyncio:AsyncIOExecutor',
            'gevent = apscheduler.dispatchers.gevent:GeventExecutor',
            'twisted = apscheduler.dispatchers.twisted:TwistedExecutor'
        ],
