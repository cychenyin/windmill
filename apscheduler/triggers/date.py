...
from apscheduler.util import convert_to_ware_datetime, datetime_repr, astimezone
...
class DateTrigger(BaseTrigger):
    ...
    def __init__(self, run_date=None, timezone=None):
        ...
        self.run_date = convert_to_ware_datetime(run_date or datetime.now(), timezone, 'run_date')
